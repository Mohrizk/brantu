...
$(".welcome").append('<h3 class=" text-center"><i class="fa fa-paw"></i><font class="font-GothamMedium"> Hey '+ User.firstName  +'! </font><br/>Lets add a preference carousel to your shopping magazine</h3>');
/**********SelectionTAB BRANDS***************************************/
